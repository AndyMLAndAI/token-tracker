  ...
  return (
    <style
      dangerouslySetInnerHTML={{
        __html: Object.entries(themePrefixes)
          .map(
            ([theme, prefix]) => `
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-[#222222] bg-[#000000] px-3 py-2 text-xs shadow-xl",
          className
        )}
      >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value && (
                        <span className="font-mono font-medium tabular-nums text-white ml-2">
        ...
        {payload.map((item: any) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[#888888]">{itemConfig?.label}</span>
            </div>
          )
        })}
      </div>
